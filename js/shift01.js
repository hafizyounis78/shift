		...
		$.ajax({
			...
			success: function(returndb){
				...
				if (action=="duplicatShift")
				{
					...
					if (returndata[0]==1)
					{
						alert("Umschalt Konflikt Bitte überprüfen Sie die ausgewählten Mitarbeiter");
...
{
	var x='';
	var r = confirm('Dieser Datensatz wird gelöscht. Möchtest du fortfahren?');
