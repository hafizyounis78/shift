...
$myquery = "SELECT sft.start_date, sft.start_time, sft.end_time, sft.end_date, sft.location_id,sft.type, loc.name, loc.color, loc.id, (
	...
	$myquery = "SELECT sft.start_date, sft.start_time, sft.end_time, sft.end_date, sft.location_id,sft.type, loc.name, loc.color, loc.id, (
						...
						FROM dusseldorf_v3_shifts sft, dusseldorf_v3_locations loc,dep_man,departments,dusseldorf_users b
						where b.id=sft.user_id
						".$dep_filter."
						and   b.dept_parent=".$this->session->userdata('dep_id').
						" GROUP BY sft.start_date, sft.start_time, sft.end_time, sft.end_date, sft.location_id, loc.name, loc.color
	...
	$myquery = "SELECT sft.start_date, sft.start_time, sft.end_time, sft.end_date, sft.location_id,sft.type, loc.name, loc.color, loc.id, (
							...
							FROM dusseldorf_v3_shifts sft, dusseldorf_v3_locations loc,dep_man,departments,dusseldorf_users users
