              ...
              <form action="#" id="shiftForm" class="form-horizontal">
                  <div class="form-body">
                      ...
                      <div class="form-group">
                          <label class="control-label col-md-3"><?php echo $this->lang->line('Is a special Shift');  ?>
                          </label>
                          <div class="col-md-4">
										...
										foreach($shiftrec as $row)
											{
												...
												if ($row->status == 1)
												 ...
												 echo '<td id="tdSpecial_shift'.$i.'">'.$specialrow.'</td>';
 												 echo '<td id="tdSpecial_shift'.$i.'">'.$row->total.'</td>';
												 echo '<td>
													  <button id="btnupdateShift" name="btnupdateShift" type="button" class="btn default btn-xs blue" onclick="updateShift('.$i.')">
													  <i class="fa fa-edit"></i>  </button>
													  <button id="btndelShift" name="btndelShift" type="submit" value="Delete" class="btn default btn-xs red" onclick="deleteShift('.$i.')"><i class="fa fa-trash-o"></i> </button>';
												 echo '</td>';  
